...
export function DashboardLayout() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-100 h-screen overflow-hidden">
      {/* Mobile Top Header */}
      <div className="md:hidden flex items-center justify-between bg-gray-100 px-4 py-3 shrink-0 relative">
        <div className="flex-1">
          <button onClick={() => setIsSidebarOpen(true)} className="p-2 text-gray-500 hover:text-gray-600 transition-colors bg-gray-200 rounded-lg flex items-center justify-center">
            <Menu size={20} />
          </button>
        </div>
        ...
        <div className="flex-1 flex justify-end">
          <div className="w-10 h-10 rounded-full bg-brand-base flex items-center justify-center text-gray-600 font-bold uppercase shrink-0 overflow-hidden">
            {avatarUrl ? (
