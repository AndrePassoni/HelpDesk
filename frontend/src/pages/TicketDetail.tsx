  ...
  return (
    <div className="flex flex-col w-full h-full">
      <header className="mb-8 w-full max-w-200 mx-auto">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-2 text-gray-200 hover:text-gray-100 transition-colors mb-1"
        >
          <ArrowLeft size={14} />
          <span className="text-[12px] font-normal">Voltar</span>
        </button>
        <h1 className="text-2xl font-bold text-brand-dark mt-1">Chamado detalhado</h1>
      </header>
        ...
        <div className="flex-1 border border-gray-500 rounded-[10px] p-6 flex flex-col gap-8 justify-center">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-brand-dark flex items-center justify-center text-sm font-bold text-gray-600 uppercase shrink-0 tracking-[1.4px]">
